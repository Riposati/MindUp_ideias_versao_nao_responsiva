	...
	<script src="../js/PaginacaoIdeiasComputacao.js" type="text/javascript"></script>
	<script src="../js/scriptQueTrazAPaginacao.js"></script>

		<div id="localizaoSite">
	    	<div id="localizaoReduzido">
	        	<span class="fontDouradaTahoma">Você está em:</span><span>Computação</span>
	    	</div>
		</div>
		<div class='computacao'><br>
			...
			<br><br>
			<table border='0' class='tabelapaginacaocomputacao'>
				<tr>
