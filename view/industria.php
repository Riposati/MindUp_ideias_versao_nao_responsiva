	...
	<script src="../js/PaginacaoIdeiasIndustria.js" type="text/javascript"></script>
	<script src="../js/scriptQueTrazAPaginacao.js"></script>

		<div id="localizaoSite">
	    	<div id="localizaoReduzido">
	    		<span class="fontDouradaTahoma">Você está em:</span><span>Indústria</span>
	    	</div>
		</div>
		<div id='computacao'><br>
